...
class _ChatScreenState extends State<ChatScreen> {
  ...
  static const apiKey = "AIzaSyCNlKBIfYd71wcC-7USBiM2946r4jrJAjE"; // Replace with your actual API key
    ...
    return Scaffold(
      appBar: AppBar(
        title: Align(
          ...
          child: Text('ECHO.AI', style: TextStyle(color: Colors.lightBlueAccent)),
        ),
